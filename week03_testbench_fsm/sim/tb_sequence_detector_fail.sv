`timescale 1ns/1ps
module tb_sequence_detector_fail;
    logic clk = 0, rst_n, serial_in, detected;
    logic [2:0] history;
    int bit_number;
    sequence_detector_fail dut (.*);
    ...
    endtask
    initial begin
        $dumpfile("build/sequence_detector_fail.vcd"); $dumpvars(0, tb_sequence_detector_fail);
        ...
        send_bit(1);
        repeat (4) send_bit(0);
        $display("tb_sequence_detector_fail: PASS"); $finish;
    end
endmodule
